...
template <class keyType, class dataType>
void binaryTree<keyType, dataType>::update(const keyType& k,
...
template <class keyType, class dataType>
void binaryTree<keyType, dataType>::update2(NodePointer aRoot,
	const keyType& k,
	const dataType& d)	const
{
	if (aRoot == NULL)
...
template <class keyType, class dataType>
void binaryTree<keyType, dataType>::traverse2(NodePointer aRoot, vector<pair<keyType, dataType>>& output) const
{
	if (aRoot != NULL)
